...
const employee = {firstName: 'first', lastName: 'last', salary: 123};
...
return employees; // Return the collected employees array
};
...
let salaryTotal = 0;
  ...
  return console.log (
    `The average salary of ${employeesArray.length} employee's is ${averageSalary}`);
};
